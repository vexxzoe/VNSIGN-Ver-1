  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-brand-50 flex flex-col items-center justify-center p-6 text-center">
        ...
        <h1 className="text-3xl font-black text-brand-950 mb-4">Dự án không tồn tại</h1>
        <p className="text-slate-500 mb-8 max-w-md">Xin lỗi, chúng tôi không tìm thấy thông tin dự án này hoặc đường dẫn đã thay đổi.</p>
        <button 
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <span className="text-white/90 text-[10px] font-black tracking-[0.25em] uppercase">DỰ ÁN TIÊU BIỂU · {project.tag}</span>
            </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 rounded-[40px] bg-white border border-brand-100 shadow-sm">
                ...
                <h3 className="text-xl font-black text-brand-950 mb-4">Thách thức</h3>
              ...
              <div className="p-8 rounded-[40px] bg-white border border-brand-100 shadow-sm">
                ...
                <h3 className="text-xl font-black text-brand-950 mb-4">Giải pháp</h3>
                <p className="text-slate-500 leading-relaxed font-medium">
                  {project.solution}
                </p>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-32 p-8 rounded-[40px] bg-brand-950 text-white shadow-2xl">
              <h3 className="text-xl font-black mb-8 border-b border-white/10 pb-4">Thông số triển khai</h3>
              <ul className="space-y-6">
                {project.specs.map((spec, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-accent-400 shrink-0 mt-1" />
                    <span className="text-white/80 font-medium leading-snug">{spec}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="mt-12 p-6 rounded-3xl bg-accent-400 text-brand-950">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-black text-xs uppercase tracking-widest">Kết quả</span>
                </div>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-8 leading-tight">
              ...
              <span className="text-accent-400">tiếp theo của bạn?</span>
            </h2>
            <p className="text-white/60 text-lg mb-12 max-w-2xl mx-auto font-medium">
              Liên hệ với đội ngũ chuyên gia VNSIGN để nhận tư vấn giải pháp Digital Signage tối ưu nhất.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              >
                Xem thêm dự án <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
          </div>
        </motion.div>
